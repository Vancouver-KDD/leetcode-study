class Solution:
    def totalFruit(self, fruits: List[int]) -> int:
        ...
        strategy
        -find longest window
        -When you encounter a new type of tree, move the left pointer to the position where the first occurrence of the second most recent type (type[right-1]).
        """
        if len(fruits) == 1:
            return 1
        ...
        # another and more understandable solution.
