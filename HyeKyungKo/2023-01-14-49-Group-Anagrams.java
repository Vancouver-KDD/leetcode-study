...
//2023-01-14
//[idea]
//Define HashMap<String, List<String>>
//make function to make key using followings:
//           int[] key = new int[26] ( fill '0' as its default)
//              for all characters, key[ch - 'a']++;
//              then, make string using StringBuilder -> append(key[i]), append('#')
//for all strings, check HashMap. if there is not the anagram key, create the map<key, new ArrayList<String>())
//   update existed map to add the string to its List
//generate List<List<String> and return the list 

//Time Complexity : O(N*K) , N is length of strs, K is maximum size among each string
