...
class Solution:    
    def is_same_tree(self, node_a, node_b):
        ...
        if node_a and node_b and node_a.value == node_b.value:
            return self.is_same_tree(node_a.left_child, node_b.left_child) and self.is_same_tree(node_a.right_child, node_b.right_child)
        else:
            return False
...
binary_tree2.insert_node(5)

print(solution.is_same_tree(binary_tree.root_node, binary_tree2.root_node))

# print(binary_tree.convert_tree_to_list())
